...
def SportsDevil():
    print "SportsDevil"
    url = "http://shadrach.pcriot.com/Add-ons/plugin.video.SportsDevil-2015-10-20-c.zip"
...
addon = xbmcaddon.Addon('plugin.video.kidsretro')
...
SOURCES = [{"url": "https://raw.githubusercontent.com/vmardesign/neotrt/master/masterPrincipal.xml", "fanart": "http://i.imgur.com/GyK9PGj.jpg"}]
